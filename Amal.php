...
<?php   if ($position == "Inscription" || $position == "Directeur") { ?>
<!DOCTYPE html>
        ...
        <div class="nk-sidebar" data-content="sidebarMenu">
            <div class="nk-sidebar-bar">
                <div class="nk-apps-brand">
                    <a href="Amal.php" class="logo-link">
                ...
                <div class="nk-sidebar-inner" data-simplebar>
                    <div class="nk-menu-content menu-active" data-content="navDashboards">
                        ...
                        <ul class="nk-menu">
                            ...
                            <?php   } elseif($position == "Inscription") { ?>
                            <li class="nk-menu-item">
                                <a href="Amal.php" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-dashboard-fill"></em></span>
                                    <span class="nk-menu-text">Inscription</span>
                                </a>
                            </li><!-- .nk-menu-item -->
                                                            ...
                                                            <div class="form-group">
                                                                <div class="form-control-wrap">
                                                                    <select name="Bank" class="form-select form-control form-control-xl" data-ui="xl" id="outlined-select">
                                                                        <option value="Espece">Bank</option>
