                ...
                <div class="nk-content ">
                    <div class="container-fluid">
                        <div class="nk-content-inner">
                                ...
                                <div class="components-preview wide-md">
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Modifier Staff</h4>
                                            </div>
                            ...
                            <form action="SaveStaff.php" method="POST" id="carsForm" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row gy-4">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" value="<?php echo $nom; ?>" name="Nom" class="form-control" id="default-01" placeholder="Nom">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" value="<?php echo $prenom; ?>" name="Prenom" class="form-control" id="default-01" placeholder="Prenom">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <input type="email" value="<?php echo $email; ?>" name="Email" class="form-control" id="default-03" placeholder="Email">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <input type="text"  value="<?php echo $tele; ?>" name="tele" class="form-control" id="default-04" placeholder="+212600000000 ">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <textarea name="Adresse" value="<?php echo $Adresse; ?>"   class="form-control no-resize" placeholder="Adresse" id="default-textarea">
                                                                        <?php echo $Adresse; ?>
                                                                    </textarea>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="password" value="<?php echo $password; ?>" name="password" class="form-control  form-control-outlined">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" value="<?php echo $ville; ?>" name="Ville"  class="form-control" id="default-01" placeholder="Ville">
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="card-inner">
                                                <div class="preview-block">
                                                        <div class="col-lg-4 col-sm-6">
                                                            <div class="form-group">
                                                                <div class="form-control-wrap">
                                                                    <select name="position" class="form-select form-control form-control-xl" data-ui="xl" id="outlined-select">
