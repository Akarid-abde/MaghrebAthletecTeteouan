...
<?php   if ($position == "Technique" || $position == "Directeur") { ?>
            ...
            <div class="nk-sidebar-main is-light">
                <div class="nk-sidebar-inner" data-simplebar>
                    <div class="nk-menu-content menu-active" data-content="navDashboards">
                        <h5 class="title">Gestion Techniques</h5>
                        <ul class="nk-menu">
                                ...
                                <div class="components-preview wide-md">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            <div class="nk-block-head-sub"><a class="back-to" href="html/Inscription.html"><em class="icon ni ni-arrow-left"></em><span>Séances</span></a></div>
                                            <h2 class="nk-block-title fw-normal">Séances</h2>
                                        ...
                                        <div class="card card-preview">
                                            <div class="card-inner">
                                                <div class="preview-block">
                                                    <form action="addSéance.php" method="POST">
                                                    <hr class="preview-hr">
                                                    <div class="card card-preview">
                                            <div class="card-inner">

                                                <div class="preview-block">
                                                    <span class="preview-title-lg overline-title">Séances</span>
                                                    <div class="row gy-4">
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <input type="text" name="Day" lang="fr" class="form-control form-control-xl form-control-outlined date-picker" id="outlined-date-picker">
                                                                    <label class="form-label-outlined" for="outlined-date-picker">Day</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <input type="text" name="Heure" class="form-control form-control-xl form-control-outlined time-picker" id="outlined-time-picker">
                                                                    <label class="form-label-outlined" for="outlined-time-picker">Heure</label>
                                                                </div>
                                                            </div>
                                                        </div>
