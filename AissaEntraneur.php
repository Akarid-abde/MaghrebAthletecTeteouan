                                ...
                                <div class="components-preview wide-md">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            <div class="nk-block-head-sub"><a class="back-to" href="AissaEntraneur.html"><em class="icon ni ni-arrow-left"></em><span>Entraineurs</span></a></div>
                                            <h2 class="nk-block-title fw-normal">Entraineurs</h2>
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Nouveau Entraineurs</h4>
                                            </div>
                                        ...
                                        <div class="card card-preview">
                                            <div class="card-inner">
                                                <div class="preview-block">
                                                    <form action="AddEntraineur.php" method="POST">
                                                           <span class="preview-title-lg overline-title">Information Entraineur</span>
                                                    <div class="row gy-4">
                                                        <div class="col-sm-6">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label class="form-label" for="default-03">Diplôme</label>
                                                                <div class="form-control-wrap">
                                                                    <div class="form-icon form-icon-left">
                                                                        <em class="icon ni ni-user"></em>
                                                                    </div>
                                                                    <input type="text" name="Diplôme" class="form-control" id="default-03" placeholder="Diplôme">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
